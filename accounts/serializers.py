...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'date_joined', 'is_student', 'is_teacher', 'is_parent']
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['email', 'password', 'password2', 'first_name', 'last_name', 'resident_state']
    ...
    def create(self, validated_data):
        ...
        # Create user with appropriate type flag
